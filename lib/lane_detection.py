...
time.sleep(.2)
#much of the following code is from the lane following tutorial in 3.5
for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):  # use_video_port=True
    ...
    #commented out code for displaying the lines found by the hough transform
    ...
    #get the points of a line from its slope and intercept
    ...
    height, width = edges.shape
    #empty lists for grouping the lines
    left_fit = []
    right_fit = []
    lane_lines = []
    boundary = 1 / 3
    ...
    if len(lane_lines) ==2:
        ...
        #checking the steering angle against the previous angle to make it so that the car can't change its heading too much in a single reading
        ...
        #code for visualizing the heading
        ...
        px.forward(0)
        time.sleep(1)
    #shwo an image that has the heading and the lane lines
